...
- **Public SDK (`Sdk`)** – A NuGet package containing only contracts (interfaces, base classes, enums, and helpers). Developers can build extensions without touching engine internals.
