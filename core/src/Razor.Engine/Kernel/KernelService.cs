...
namespace Razor.Engine.Kernel;

using Razor.Engine.Extensions;
using Razor.Engine.Management.Tasks;
using Razor.Kernel.Backtesting;
using Razor.Kernel.Brokers;
using Razor.Kernel.Clock;
using Razor.Kernel.Configuration;
using Razor.Kernel.Indicators;
using Razor.Kernel.Messaging;
using Razor.Kernel.Optimization;
using Razor.Kernel.Telemetry;
using Razor.Sdk.Hooks;
using Razor.Sdk.Shared;
using Razor.Sdk.Slots.Adapter;
using Razor.Sdk.Slots.NeuralNetwork;
using Razor.Sdk.Slots.Strategy;
using Razor.Shared;
using Microsoft.Extensions.Logging;
using System.Collections.Concurrent;
using System.Collections.Immutable;
using ChromosomeKernel = Razor.Kernel.Optimization.Chromosome;

/// <summary>
/// Real implementation of <see cref="IKernelService"/> using the Razor.Kernel components.
/// </summary>
