...
internal sealed class LoggingService : ILoggingService, IAsyncDisposable
{
    ...
    public Task InitializeAsync(CancellationToken cancellationToken)
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .MinimumLevel.Override("Razor.Engine.Extensions", LogEventLevel.Warning)
            .MinimumLevel.Override("Razor.Engine.Communication.CloudConnector", LogEventLevel.Warning)
