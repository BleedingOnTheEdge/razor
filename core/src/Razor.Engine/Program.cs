...
namespace Razor.Engine;

using Razor.Engine.Kernel;
using Razor.Kernel.Hooks;
...
internal sealed class Program
{
    ...
    private static void PrintHelp()
    {
        ...
        Console.WriteLine("Usage: Razor.Engine [options]");
        ...
        Console.WriteLine("  sc create RazorEngine binPath= \"C:\\Path\\Razor.Engine.exe --service --auth=user,pass,key\"");
        Console.WriteLine("\nService installation (Linux):");
        Console.WriteLine("  Create /etc/systemd/system/Razor.service with:");
        Console.WriteLine("  [Service]");
        Console.WriteLine("  ExecStart=/opt/Razor/Razor.Engine --service --auth=user,pass,key");
